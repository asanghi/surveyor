class Dependency < ActiveRecord::Base
  ...
  validates :question_id, :numericality => true, :if => Proc.new { |d| d.question_group_id.nil? }
  validates :question_group_id, :numericality => true, :if => Proc.new { |d| d.question_id.nil? }
